...
[webservers]
webserver ansible_host=${webserver_private_ip} ansible_user=ec2-user ansible_ssh_private_key_file=./keys/web_server_key ansible_ssh_common_args='-o ProxyCommand="ssh -W %h:%p -q ubuntu@${bastion_private_ip} -o StrictHostKeyChecking=no -i ./keys/bastion_key"'
